...
<!-- Making a new element in the DOM means creating a new HTML tag with JavaScript, giving it some text or a class if you want, and then putting it somewhere on the page so it actually shows up. -->
